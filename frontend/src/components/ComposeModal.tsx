...
import { listAccounts, sendEmail, type Account } from "../api";
        ...
        <div className="px-5 py-4 space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <select
              ...
              className="flex-1 bg-gray-800 text-gray-200 text-sm px-3 py-1.5 rounded-lg outline-none focus:ring-1 ring-blue-500"
            >
              {accounts.map(a => (
          ...
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              className="flex-1 bg-gray-800 text-gray-100 text-sm px-3 py-1.5 rounded-lg outline-none focus:ring-1 ring-blue-500 placeholder-gray-500"
            />
          </div>
